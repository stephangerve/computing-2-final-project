...
public class LightningCrossbow extends Spell{

	public LightningCrossbow(){
		...
		setSpellDesc("Increase friendly monster's atk by 2; Increase by 3 if light element type.");
	}
	public void activateSpell(Player your, Player opponent){
		System.out.println("\tChoose friendly monster to increase their atk by 2 or 3 if light element type.");
		System.out.println("\t----------");
		...
		System.out.print(">> ");
		sm.makeChoice();
		if(((Monster) your.field.get(sm.getChoice() - 1)).elementType.getElementType() == "Light"){
